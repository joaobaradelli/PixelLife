...
if (isset($_POST['concluir'])) {
    ...
    $antigo = $_SESSION['usuario'];
    $email = $_SESSION['email'];
    $senha = $_SESSION['senha'];

    $sql = "UPDATE usuario
    SET nome_usuario = '$novo_usuario'
    WHERE nome_usuario = '$antigo' and email = '$email' and senha = '$senha'";
...
<body>
    ...
    <div class="all">
        ...
        <P CLASS="tituloUpload">Alterar Usuário</P>
        <form class="form" action="" method="post">
            <div class="mb-3">
            </div>
            <label for="titulo" class="text">Novo nome do usuário</label></br>
            <input type="text" name="usuario" class="cxdt" required></br>
